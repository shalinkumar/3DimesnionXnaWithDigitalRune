...
using JohnStriker.GameObjects.CameraObject;
...
{
    public class InGameUIScreen : UIScreen
    {
            ...
            : base("InGame", renderer)
        {
            ...
            _cameraObject =   (ThirdPersonCameraObject)gameObjectService.Objects["ThirdPersonCamera"];
