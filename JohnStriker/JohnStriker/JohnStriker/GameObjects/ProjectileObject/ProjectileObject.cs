...
namespace JohnStriker.GameObjects.ProjectileObject
{
    public class ProjectileObject : GameObject
    {
        ...
        public ProjectileObject(IServiceLocator services)
        {
            Name = "BallShooter";
            Speed = 100;
        ...
        protected override void OnLoad()
        {
            ...
            var sphereShape = new SphereShape(2f);
        ...
        protected override void OnUpdate(TimeSpan deltaTime)
        {
                ...
                || _inputService.IsPressed(Buttons.RightTrigger, true, LogicalPlayerIndex.One))
            {
                ...
                var cameraGameObject = (VehicleCameraObject.VehicleCameraObject)_gameObjectService.Objects["Camera"];
