...
namespace JohnStriker.GameObjects.DynamicSkyObject
{
    ...
    public class DynamicSkyObject : GameObject
    {
        ...
        private ThirdPersonCameraObject.ThirdPersonCameraObject _cameraObject;
    ...
    private DateTime _time = new DateTime(2014, 06, 01, 14, 0, 0, 0);  //DateTime.Now;
        ...
        protected override void OnLoad()
        {
            ...
            _cameraObject = (ThirdPersonCameraObject.ThirdPersonCameraObject)gameObjectService.Objects["ThirdPersonCamera"];
...
#endif
#if !MONOGAME && !XBOX
                        // We need to enable mip maps. Otherwise, we can get a cube map with some black faces.
                        // This seems to be a graphics driver or XNA bug!?
                      true,
#else
