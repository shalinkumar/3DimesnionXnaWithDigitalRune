...
namespace JohnStriker.GameObjects.AmmoObject
{
    ...
    public class AmmoObjectThree : GameObject
    {
        // Note:
        ...
        public AmmoObjectThree(IServiceLocator services)
        {
            _services = services;
        ...
        public void Spawn(Pose startPose, Pose cameraPose)
        {
            ...
            _bodyPrototype.Pose = startPose;
            //_bodyPrototype.Pose = _bodyPrototype.Pose;
        ...
        protected override void OnUpdate(TimeSpan deltaTime)
        {
            ...
            if (_bodyPrototype.Simulation != null)
            {
                _simulation.RigidBodies.Remove(_bodyPrototype);
            }
            ...
            _bodyPrototype.LinearVelocity = forwardCameraPose * 100;
            _modelPrototype.PoseWorld = _bodyPrototype.Pose;
