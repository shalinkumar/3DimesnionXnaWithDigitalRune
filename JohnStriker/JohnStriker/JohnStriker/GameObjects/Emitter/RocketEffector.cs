...
namespace JohnStriker.GameObjects.Emitter
{
    ...
    public class RocketEffector : ParticleEffector
    {
        ...
        public RocketEffector(IServiceLocator services)
        {
        ...
        {
            return new RocketEffector(Services);
        }
        ...
        //            continue;
        //        }
        //        var cameraGameObject = (MissileObject.MissileObject)_gameObjectService.Objects["Vehicle"];
        //        //var cameraNode = cameraGameObject.CameraNode;
        //        Pose cameraPose=new Pose();
        //        //Pose cameraPose = cameraGameObject.RigidBodyLavaBody.Pose;
        ...
        //            trail.Parameters.Get<Vector3F>(ParticleParameterNames.EmitterVelocity).DefaultValue = forward * 2;
        //        }
        //        else
        //        {
        ...
        //            //explosion.Pose = cameraPose;
        //            //explosion.Parameters.Get<Vector3F>(ParticleParameterNames.EmitterVelocity).DefaultValue = new Vector3F(cameraPose.Position.X,cameraPose.Position.Y,cameraPose.Position.Z) * 2;
