...
namespace JohnStriker.Sample_Framework
{

    public sealed class GuiLoadingScreen : DigitalRune.Graphics.GraphicsScreen, IDisposable
    {
        ...
        public GuiLoadingScreen(IServiceLocator services)
            : base(services.GetInstance<IGraphicsService>())
        {
            Name = "GuiLoadingScreen"; // Just for debugging.
            ...
            UIScreen = new UIScreen("GuiLoadingScreen", renderer)
            {
