...
{
    public sealed class GuiCustomScreen : DigitalRune.Graphics.GraphicsScreen, IDisposable
    {
        ...
        public GuiCustomScreen(IServiceLocator services, int objectCount)
            : base(services.GetInstance<IGraphicsService>())
        {
            Name = "GuiCustomScreen" + objectCount; // Just for debugging.
            ...
            UIScreen = new UIScreen("GuiCustomScreen" + objectCount, renderer)
            {
