...
namespace JohnStriker
{
    ...
    public sealed class GuiScreenBoat : DigitalRune.Graphics.GraphicsScreen, IDisposable
    {
        ...
        public GuiScreenBoat(IServiceLocator services)
            : base(services.GetInstance<IGraphicsService>())
        {
            Name = "GuiScreenBoat"; // Just for debugging.
            ...
            UIScreen = new UIScreen("GuiScreenBoat", renderer)
            {
