...
namespace JohnStriker.Sample_Framework
{
    ...
    public sealed class GuiCameraScreen : DigitalRune.Graphics.GraphicsScreen, IDisposable
    {
        ...
        public GuiCameraScreen(IServiceLocator services)
            : base(services.GetInstance<IGraphicsService>())
        {
            Name = "GuiCustomScreen"; // Just for debugging.
            ...
            UIScreen = new UIScreen("GuiCustomScreen", renderer)
            {
