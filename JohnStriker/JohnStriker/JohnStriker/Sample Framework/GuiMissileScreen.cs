...
{   
    public sealed class GuiMissileScreen : DigitalRune.Graphics.GraphicsScreen, IDisposable
    {
        ...
        public GuiMissileScreen(IServiceLocator services)
            : base(services.GetInstance<IGraphicsService>())
        {
            Name = "GuiMissileScreen"; // Just for debugging.
            ...
            UIScreen = new UIScreen("GuiMissileScreen", renderer)
            {
