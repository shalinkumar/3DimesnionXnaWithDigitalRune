...
{    
    ...
    public sealed class GuiPathScreen : DigitalRune.Graphics.GraphicsScreen, IDisposable
    {
        ...
        public GuiPathScreen(IServiceLocator services)
            : base(services.GetInstance<IGraphicsService>())
        {
            Name = "GuiPathScreen"; // Just for debugging.
            ...
            UIScreen = new UIScreen("GuiPathScreen", renderer)
            {
