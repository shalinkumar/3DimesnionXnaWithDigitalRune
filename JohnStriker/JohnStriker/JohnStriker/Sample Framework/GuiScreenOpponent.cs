...
namespace JohnStriker
{
    ...
    public sealed class GuiScreenOpponent : DigitalRune.Graphics.GraphicsScreen, IDisposable
    {
        ...
        public GuiScreenOpponent(IServiceLocator services)
            : base(services.GetInstance<IGraphicsService>())
        {
            Name = "GuiScreenOpponent"; // Just for debugging.
            ...
            UIScreen = new UIScreen("GuiScreenOpponent", renderer)
            {
