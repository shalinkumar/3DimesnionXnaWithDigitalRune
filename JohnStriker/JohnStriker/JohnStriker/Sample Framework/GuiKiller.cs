...
{
    public sealed class GuiKiller : DigitalRune.Graphics.GraphicsScreen, IDisposable
    {
        ...
        public GuiKiller(IServiceLocator services)
            : base(services.GetInstance<IGraphicsService>())
        {
            Name = "GuiKiller"; // Just for debugging.
            ...
            UIScreen = new UIScreen("GuiKiller", renderer)
            {
